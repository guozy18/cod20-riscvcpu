...
//parameter BASE_RAM_INIT_FILE = "F:\\2020Fighting\\Computer Organization\\repos\\cod20-grp27\\asm\\fib0\\1.bin";
//parameter BASE_RAM_INIT_FILE = "F:\\2020Fighting\\Computer Organization\\repos\\cod20-grp27\\asm\\csr\\1.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�?
parameter BASE_RAM_INIT_FILE = "F:\\2020Fighting\\Computer Organization\\repos\\cod20-grp27\\sim\\random_4M.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�?
//parameter BASE_RAM_INIT_FILE = "F:\\2020Fighting\\Computer Organization\\repos\\cod20-grp27\\asm\\uart\\1.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�?
...
initial begin 
    ...
    */
    ...
    #1000;
    cpld.pc_send_byte(8'hff);
    #1000;
    cpld.pc_send_byte(8'h44);
    #1000;
    cpld.pc_send_byte(8'h69);
    #500000;
    reset_btn = 1;
    #1000;
    reset_btn = 0;
